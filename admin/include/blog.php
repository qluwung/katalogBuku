            ...
            <div class="card">
              ...
              <table class="table table-bordered">
                    ...
                    <?php
                      ...
                      $sql_k.="order by `b`.`judul`,`b`.`tanggal` limit $posisi,$batas";
                      ...
                      <tr>
                        ...
                        <td align="center">
                          ...
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $judul; ?>?'))
                            window.location.href='index.php?include=blog&aksi=hapus&data=<?php echo $id_blog ?>&notif=hapusberhasil'" 
              ...
              <?php
                  ...
                  $sql_jum.="order by `b`.`judul`,`b`.`tanggal`";
                ...
                if($jum_halaman==0){
                  ...
                  if($halaman!=1){
                    ...
                    echo "<li class='page-item'><a class='page-link' href='index.php?include=blog&halaman=$sebelum'>&laquo;</a></li>";
                  }
                  ...
                  if($halaman!=$jum_halaman){
                    echo "<li class='page-item'><a class='page-link' href='index.php?include=blog&halaman=$setelah'>&raquo;</a></li>";
