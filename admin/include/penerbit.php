    ...
    <section class="content">
            <div class="card">
              ...
              <?php if(!empty($_GET['notif'])){ ?>
                <?php if($_GET['notif']=='tambahberhsil'){ ?>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        window.location.href='index.php?include=penerbit&aksi=hapus&data=<?php echo $id_penerbit ?>&notif=hapusberhasil'" 
                ...
                <?php
                  if($jum_halaman==0){
                    ...
                    if($halaman!=$jum_halaman){
                      echo "<li class='page-item'><a class='page-link' href='index.php?include=penerbit&halaman=$setelah'>&raquo;</a></li>";
