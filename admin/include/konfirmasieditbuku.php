<?php
    if(isset($_SESSION['id_buku'])){
        ...
        if(empty($id_kategori_buku)){
            header("Location:index.php?include=edit-buku&data=".$id_buku."&notif=editkosong&jenis=Kategori%20Buku");
        }else if(empty($judul)){
            ...
            header("Location:index.php?include=edit-buku&data=".$id_buku."&notif=editkosong&jenis=Tahun%20Terbit");
        }else if(empty($sinopsis)){
            header("Location:index.php?include=edit-buku&data=".$id_buku."&notif=editkosong&jenis=Sinopsi");
        }else if(empty($tag)){
