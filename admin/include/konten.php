                ...
                <?php
                  if($jum_halaman==0){
                    ...
                    if($halaman!=1){
                      ...
                      echo "<li class='page-item'><a class='page-link' href='index.php?include=konten&halaman=$sebelum'>&laquo;</a></li>";
                    }
                    ...
                    if($halaman!=$jum_halaman){
                      echo "<li class='page-item'><a class='page-link' href='index.php?include=konten&halaman=$setelah'>&raquo;</a></li>";
