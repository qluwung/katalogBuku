                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center">
                        ...
                        window.location.href='index.php?include=tag&aksi=hapus&data=<?php echo $id_tag; ?>&notif=hapusberhasil'" 
                  ...
                  if($jum_halaman==0){
                    ...
                    $setelah=$halaman+1;
                      if($halaman!=1){
                        ...
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=tag&halaman=$sebelum'>&laquo;</a></li>";
                      }
                      ...
                      if($halaman!=$jum_halaman){
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=tag&halaman=$setelah'>&raquo;</a></li>";
