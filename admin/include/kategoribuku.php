                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        window.location.href='index.php?include=kategori-buku&aksi=hapus&data=<?php echo $id_kategori_buku; ?>&notif=hapusberhasil'" 
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                  ...
                  if($jum_halaman==0){
                    ...
                    if($halaman!=$jum_halaman){
                      echo "<li class='page-item'><a class='page-link' href='index.php?include=kategori-buku&halaman=$setelah'>&raquo;</a></li>";
